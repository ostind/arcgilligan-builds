...
// include: /tmp/tmpdguxnysu.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/runner/work/arcgilligan/arcgilligan/build/web/dist/arcgilligan.data';
      var REMOTE_PACKAGE_BASE = 'arcgilligan.data';
...
Module['FS_createPath']("/home/runner", "work", true, true);
...
Module['FS_createPath']("/home/runner/work/arcgilligan/arcgilligan/static", "texture", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/home/runner/work/arcgilligan/arcgilligan/build/web/dist/arcgilligan.data');
      }
      Module['addRunDependency']('datafile_/home/runner/work/arcgilligan/arcgilligan/build/web/dist/arcgilligan.data');
...
// end include: /tmp/tmpdguxnysu.js
// include: /tmp/tmpmhqfbd4f.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpmhqfbd4f.js
// include: /tmp/tmpfe3niqiu.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpfe3niqiu.js
...
function findWasmBinary() {
  return locateFile('arcgilligan.wasm');
}
...
// Begin JS library code
  ...
  var _wgpuDeviceGetFeatures = (devicePtr, supportedFeatures) => {
      var device = WebGPU.getJsObject(devicePtr);
...
var dynCall_viidd = makeInvalidEarlyAccess('dynCall_viidd');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['dynCall_viidd'] != 'undefined', 'missing Wasm export: dynCall_viidd');
  ...
  _setWindowSize = Module['_setWindowSize'] = createExportWrapper('setWindowSize', 3);
  ...
  dynCall_viidd = dynCalls['viidd'] = createExportWrapper('dynCall_viidd', 5);
...
var wasmImports = {
  ...
  /** @export */
  wgpuDeviceGetFeatures: _wgpuDeviceGetFeatures,
  /** @export */
